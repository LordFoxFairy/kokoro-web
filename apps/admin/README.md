...
- Credit is read only through generated AdminCredit routes. Legacy manifest/resource/action/OpenAPI Credit access, billing overview aggregation, and User360 Credit fan-out are closed. The User page uses the typed one-User-within-Site AdminQuery read.
