...
Read target-state documents in this order before changing the IAM control plane:

1. `product/PRD-001-iam-control-plane.md`
2. `architecture/iam-control-plane-technical-design.md`
