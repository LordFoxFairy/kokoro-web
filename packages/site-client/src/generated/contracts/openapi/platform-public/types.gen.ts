...
export type SessionAccessGrantBinding = {
    ...
    /**
     * Canonical global stream sequence of the committed GrantDelivered authorization feed event. It is part of the signed grant binding and lets Session wait until its local authorization projection has reached the grant's authority point.
     */
    authorizationStreamSequence: PositiveUint64String;
