...
describe("Chat Markdown rendering", () => {
  ...
  it("renders strict Media, Artifact, and Cost owner states without inventing delivery URLs", () => {
    ...
    const parts: readonly ChatPart[] = [
      ...
      { ...common, id: "artifact-1", ordinal: 4, lifecycle: "completed", kind: "artifact", artifactRef: "artifact-final", artifactVersionRef: "artifact-v1", ownerVersion: "11", mediaClass: "image", availability: "ready", display: { kind: "image", format: "png", width: 1024, height: 768, byteSize: "245760" }, updatedAt: "2026-07-28T00:00:00.000Z" },
